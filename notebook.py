...
def _mode(mo):
    mode = mo.ui.dropdown(
        options={
            ...
            "upisnik_vu":       "Ustanove — visoka učilišta",
            "upisnik_jzi":      "Ustanove — javni znan. instituti",
            "ppg_podrucja":     "Ustanove — PPG područja",
            # CROSBI API
            "crosbi_osoba_mbz": "CROSBI — publikacije osobe (MBZ)",
            "crosbi_pub_id":    "CROSBI — publikacija po ID-u",
            # Oprema API
